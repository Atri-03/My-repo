...
app = FastAPI(
    ...
    description="Extracts functional/non-functional requirements, risks, entities and business rules from transcripts.",
    version="1.0.0",
)
...
def health():
    return {"status": "ok", "service": "document_extraction_service"}
